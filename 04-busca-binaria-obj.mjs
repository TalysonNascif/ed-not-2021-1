...
console.timeEnd('Buscando LARARA')
...
console.time('Buscando JOANA')
console.log(buscaBinaria(objNomes, (obj, busca = 'JOANA') => {
    if(busca === obj.first_name) return 0
    else if(busca < obj.first_name) return -1
    else return 1
}), {comps})
console.timeEnd('Buscando JOANA')

console.time('Buscando LEILAINE')
console.log(buscaBinaria(objNomes, (obj, busca = 'LEILAINE') => {
    if(busca === obj.first_name) return 0
    else if(busca < obj.first_name) return -1
    else return 1
}), {comps})
console.timeEnd('Buscando LEILAINE')

console.time('Buscando CECILIA')
console.log(buscaBinaria(objNomes, (obj, busca = 'CECILIA') => {
    if(busca === obj.first_name) return 0
    else if(busca < obj.first_name) return -1
    else return 1
}), {comps})
console.timeEnd('Buscando CECILIA')

console.time('Buscando NICOLY')
console.log(buscaBinaria(objNomes, (obj, busca = 'NICOLY') => {
    if(busca === obj.first_name) return 0
    else if(busca < obj.first_name) return -1
    else return 1
}), {comps})
console.timeEnd('Buscando NICOLY')
